...
async def runprogram():
    ...
    program_crc = crc(PROGRAM_TO_UPLOAD)
    ...
    running_crc = 0
    for i in range(0, len(PROGRAM_TO_UPLOAD), info_response.max_chunk_size):
        chunk = PROGRAM_TO_UPLOAD[i : i + info_response.max_chunk_size]
